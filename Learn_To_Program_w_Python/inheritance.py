class Animal:
    def __init__(self, birthType="Unknown", appearance="Unknown", blooded="Unkown"):
    ...
    def __str__(self):
        return "A {} is {} it has {} it is {}".format(type(self).__name__, self.birthType, self.appearance,
                                                      self.blooded)
